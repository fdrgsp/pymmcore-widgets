...
class _PlateCalibration(QWidget):
    ...
    def __init__(
        ...
        *,
        ...
        self._calibration_wells_combo.currentTextChanged.connect(self._on_combo_changed)
    ...
    def _reset_calibration_variables(self, set_to_none: bool) -> None:
        ...
        self._calculated_well_spacing_x = (
            None if set_to_none or not self.plate else self.plate.well_spacing_x * 1000
        )
        self._calculated_well_spacing_y = (
            None if set_to_none or not self.plate else self.plate.well_spacing_y * 1000
        )
