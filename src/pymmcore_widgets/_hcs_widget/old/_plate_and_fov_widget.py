...
# from ._fov_widget import Center, Random, _FOVSelectrorWidget
...
#         self._fov_selector._update(self._plate_widget.current_plate())
...
#         self._fov_selector._update(plate)
...
#         with signals_blocked(self._plate_widget.plate_combo):
#             self._plate_widget.plate_combo.clear()
#             self._plate_widget.plate_combo.addItems(list(self._plate_db))
#         self._plate_widget.plate_combo.setCurrentText(
#             new_plate.id if new_plate else self._plate_widget.plate_combo.itemText(0)
#         )
